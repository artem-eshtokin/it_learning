'''
Виселица - программа загадывает слово, а пользователь должен его угадать.
'''

import random

words_list = ['год', 'человек', 'время', 'дело', 'жизнь', 'день', 'рука', 'раз', 'работа', 'слово', 'место', 'лицо',
...
def play(word):
    ...
    while '_' in word_completion:
        att = input('Введите букву или слово целиком:').upper()
        
        if len(att) == 1 and att.isalpha(): # Если ввели одну букву
            
            if att in guessed_letters: # Была буква?
                print('Эта буква уже была')
                
            elif att in word: # Если буква есть в слове
                word_completion_temp = ''
                for i in range(len(word)):
                    if att == word[i] and word_completion[i] == '_':
                        word_completion_temp += att
                    elif word_completion[i] != '_':
                        word_completion_temp += word_completion[i]
                    else:
                        word_completion_temp += '_'
                word_completion = word_completion_temp    
                print('Ваше слово:', word_completion)
            ...
            if att not in guessed_letters:
                guessed_letters.append(att) # добавляем в список букв-попыток
            print('Попытки\nБуквы:', *guessed_letters)
            print('Слова:', *guessed_words)
            print()
            print(word_completion)
            print()
        
        
        elif len(att) == len(word) and att.isalpha(): # Если ввели слово
            
            if att in guessed_words: # Было слово?
            ...
            if att not in guessed_words:
                guessed_words.append(att)
            print('Попытки\nБуквы:', *guessed_letters)
            print('Слова:', *guessed_words)
            print()
            print(word_completion)
